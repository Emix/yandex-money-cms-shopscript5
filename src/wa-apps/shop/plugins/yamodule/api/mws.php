...
Class Mws
{
	...
	public static function upload(){
		...
		if (!isset($json['error'])){
			...
			$sm->set('shop.yamodule' , 'yamodule_mws_cert', $cert);
		}
	...
	public static function generateCsr(){
		...
		$sm->set('shop.yamodule' , 'yamodule_mws_csr', $csr);
		$sm->set('shop.yamodule' , 'yamodule_mws_csr_sign', $sign);
		$sm->set('shop.yamodule' , 'yamodule_mws_cert', '');
	}
